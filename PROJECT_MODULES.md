...
- [后端模块](#后端模块)
  ...
  - [认证路由 (routes/auth.js)](#6-认证路由-routesauthjs)
  - [AI智能体路由 (routes/aiAgentRoutes.js)](#7-ai智能体路由-routesaiagentroutesjs)
  - [Socket.IO入口 (socket/index.js)](#8-socketio入口-socketindexjs)
  - [房间管理器 (socket/roomHandler.js)](#9-房间管理器-socketroomhandlerjs)
  - [游戏事件处理器 (socket/gameHandler.js)](#10-游戏事件处理器-socketgamehandlerjs)
  - [游戏引擎 (game/GameEngine.js)](#11-游戏引擎-gamegameenginejs)
  - [AI游戏处理器 (game/AIGameHandler.js)](#12-ai游戏处理器-gameaigamehandlerjs)
  - [角色配置 (game/RoleConfig.js)](#13-角色配置-gameroleconfigjs)
  - [游戏常量 (game/constants.js)](#14-游戏常量-gameconstantsjs)
  - [AI智能体管理器 (ai/AIAgentManager.js)](#15-ai智能体管理器-aiaigentmanagerjs)
  - [缓存工具 (utils/cache.js)](#16-缓存工具-utilscachejs)
  - [自定义错误类 (utils/AppError.js)](#17-自定义错误类-utilsapperrorjs)
  - [用户Socket映射 (utils/userSocketMap.js)](#18-用户socket映射-utilsusersocketmapjs)
- [前端模块](#前端模块)
  - [应用入口 (main.js / App.vue)](#1-应用入口-mainjs--appvue)
  - [路由配置 (router/index.js)](#2-路由配置-routerindexjs)
  - [API封装 (api.js)](#3-api封装-apijs)
  - [Socket封装 (socket.js)](#4-socket封装-socketjs)
